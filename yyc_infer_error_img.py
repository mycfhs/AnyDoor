...
# 读取YAML文件
with open("categories.yml", "r") as yml_file:
...
seed = 42  #
# special_tag = ""
train_data_dir = "/home/zl/yyc_workspace/Fooocus_diffusers/train_data"
...
def process_pairs(ref_image, ref_mask, tar_image, tar_mask):
    ...
    print(ref_image_collage.shape, (x2 - x1, y2 - y1))
...
if __name__ == '__main__': 
    ...
    bg_dir = "/home/zl/yyc_workspace/Fooocus_diffusers"
    ...
    for index, category in enumerate(tqdm(category_list)):
        if category != "shiny_sneaker":
            continue

        folder_path = f"./output/anydoor_bg4k/{category}"

        # for img_name in all_bg[index :: category_num]:
        img_name = "24"
        img_name = str(img_name)
        ref_image_url = f"/home/zl/yyc_workspace/Fooocus_diffusers/train_data/{category}/image/00.jpg"
        ref_image = cv2.imread(ref_image_url)

        ref_mask_url = f"/home/zl/yyc_workspace/Fooocus_diffusers/train_data/{category}/mask/00.png"
        img_url = f"/home/zl/yyc_workspace/Fooocus_diffusers/{img_name}_1.png"
        mask_url = f"/home/zl/yyc_workspace/Fooocus_diffusers/{img_name}_2.png"
        ...
        gen_path = f"./{img_name}+None+{seed}.jpg"
